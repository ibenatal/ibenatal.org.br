...
export const metadata = {
  ...
  description: "Reflexão sobre Lucas 10 e o chamado de Jesus para nos tornarmos próximos de quem precisa, deslocando a pergunta de 'quem é o meu próximo?' para 'de quem eu serei próximo?'.",
