...
export const metadata = {
  ...
  description:
    'Reflexão cristã sobre velórios e sepultamentos: lágrimas são humanas, mas a esperança em Cristo é sobrenatural. A morte não é o fim, mas passagem para a vida eterna, testemunhando fé e confiança na obra consumada de Jesus.',
  author: {
