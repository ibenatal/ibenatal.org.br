...
export const metadata = {
  ...
  description: "Uma reflexão sobre Marcos 2:1-5 acerca da fé dos amigos que remove barreiras e nos leva a Jesus, convidando-nos a carregar e a ser carregados.",
