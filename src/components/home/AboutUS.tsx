...
import { CardParagraph, CardTitle, SectionDescription, SectionTitle } from './HomeTypography';
  ...
  return (
    <div className={cn('flex flex-col items-center gap-6 sm:gap-8', className)}>
      ...
      <CardParagraph className="lg:text-lg">
        <span className="font-bold">Atrair</span> pessoas para Cristo, Conduzir essas pessoas a{' '}
        <span className="font-bold">pertencerem</span> ao Corpo de Cristo, Ensinar o que Cristo
        ordenou através do <span className="font-bold">discipulado</span>, Conduzir essas pessoas a{' '}
        <span className="font-bold">servirem</span> a Cristo ao servir aos outros e levar essas
        pessoas a experimentarem o privilégio de <span className="font-bold">multiplicar-se</span>{' '}
        em outros discípulos de Cristo.
      </CardParagraph>
    </div>
  );
};
...
const PilaresContent = ({ className }: { className?: string }) => {
  return (
    <div className={cn('flex flex-col items-center gap-6 sm:gap-8', className)}>
      ...
      <CardParagraph className="lg:text-lg">
        As etapas que a igreja utiliza para ajudar as pessoas a crescerem em sua fé e se tornarem
      ...
      <ul className="w-full list-inside list-decimal text-sm leading-relaxed sm:text-base md:w-auto lg:ml-2 lg:text-lg">
        ...
        <li>
          Pertencer:{' '}
          <span className="font-bold">Criar relacionamentos e senso de pertencimento.</span>
        </li>
        <li>
          Discipular: <span className="font-bold">Ensinar e equipar para o crescimento.</span>
        </li>
        <li>
          Servir: <span className="font-bold">Usar dons e talentos para o Reino.</span>
        </li>
        <li>
          Multiplicar: <span className="font-bold">Compartilhar a fé e investir em outros.</span>
        </li>
      </ul>
    </div>
  );
